...
angular.module('uiBreadcrumbs', ['ui.router', 'myvcFrontApp'])

    .directive('uiBreadcrumbs', function($interpolate, $state, App) {
        return {
            restrict: 'E',
            templateUrl: App.views + 'directives/uiBreadcrumbs.tpl.html',
            scope: {
                displaynameProperty: '@'
            },
            link: function(scope) {
